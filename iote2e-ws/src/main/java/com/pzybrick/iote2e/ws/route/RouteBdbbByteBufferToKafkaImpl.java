...
/**
 * The Class RouteBdbbByteBufferToKafkaImpl.
 */
public class RouteBdbbByteBufferToKafkaImpl implements RouteBdbbByteBuffer {
	...
	/**
	 * Instantiates a new route bdbb byte buffer to kafka impl.
	 */
	...
	/* (non-Javadoc)
	 * @see com.pzybrick.iote2e.ws.route.RouteBdbbByteBuffer#init(com.pzybrick.iote2e.common.config.MasterConfig)
	 */
	...
	/* (non-Javadoc)
	 * @see com.pzybrick.iote2e.ws.route.RouteBdbbByteBuffer#routeToTarget(java.nio.ByteBuffer)
	 */
