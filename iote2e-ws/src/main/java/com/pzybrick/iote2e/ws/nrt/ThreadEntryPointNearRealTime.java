...
/**
 * The Class ThreadEntryPointNearRealTime.
 */
public class ThreadEntryPointNearRealTime extends Thread {
	...
	/** The Constant serverSideSocketNearRealTimes. */
	...
	/**
	 * Instantiates a new thread entry point near real time.
	 */
	...
	/**
	 * The Class ThreadToBrowserNrtMonitor.
	 */
