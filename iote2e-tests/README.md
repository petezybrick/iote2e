...
Note: if the topic doesn't already exist, then create it now:
	...
	./bin/kafka-topics.sh  --create --topic com.pzybrick.iote2e.ws.validic.ThreadEntryPointValidic-sandbox --zookeeper localhost:2181 --replication-factor 3  --partitions 3
