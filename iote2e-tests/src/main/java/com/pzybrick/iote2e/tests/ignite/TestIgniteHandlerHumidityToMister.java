...
/**
 * The Class TestIgniteHandlerHumidityToMister.
 */
...
public class TestIgniteHandlerHumidityToMister extends TestIgniteHandlerBase {
	...
	/**
	 * Instantiates a new test ignite handler humidity to mister.
	 *
	...
	/**
	 * Test humidity to mister rule fire fan off.
	 *
	 * @throws Exception the exception
	 */
	@Test
	...
	/**
	 * Test humidity to mister rule fire fan on.
	 *
	 * @throws Exception the exception
	 */
	@Test
	...
	/**
	 * Test humidity to mister rule not fire.
	 *
	 * @throws Exception the exception
	 */
	@Test
