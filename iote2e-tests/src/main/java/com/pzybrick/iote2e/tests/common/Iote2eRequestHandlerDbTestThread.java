...
/**
 * The Class Iote2eRequestHandlerDbTestThread.
 */
...
//	private RuleConfig ruleConfig;
	...
	/**
	 * Instantiates a new iote 2 e request handler db test thread.
	 *
	 ...
	 *
	 * @param iote2eRequests the iote 2 e requests
	 * @return the iote 2 e request handler db test thread
	 */
