...
public class SourceSensorValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3675653889380392859L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SourceSensorValue\",\"namespace\":\"com.pzybrick.avro.schema\",\"fields\":[{\"name\":\"source_uuid\",\"type\":\"string\"},{\"name\":\"sensor_uuid\",\"type\":\"string\"},{\"name\":\"sensor_value\",\"type\":\"string\"}]}");
   ...
   */
  public static com.pzybrick.avro.schema.SourceSensorValue.Builder newBuilder() {
    return new com.pzybrick.avro.schema.SourceSensorValue.Builder();
  }
   ...
   * @return A new SourceSensorValue RecordBuilder
   */
  public static com.pzybrick.avro.schema.SourceSensorValue.Builder newBuilder(com.pzybrick.avro.schema.SourceSensorValue.Builder other) {
    return new com.pzybrick.avro.schema.SourceSensorValue.Builder(other);
  }
   ...
   * @return A new SourceSensorValue RecordBuilder
   */
  public static com.pzybrick.avro.schema.SourceSensorValue.Builder newBuilder(com.pzybrick.avro.schema.SourceSensorValue other) {
    return new com.pzybrick.avro.schema.SourceSensorValue.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SourceSensorValue>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pzybrick.avro.schema.SourceSensorValue.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pzybrick.avro.schema.SourceSensorValue other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.source_uuid)) {
        this.source_uuid = data().deepCopy(fields()[0].schema(), other.source_uuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pzybrick.avro.schema.SourceSensorValue.Builder setSourceUuid(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pzybrick.avro.schema.SourceSensorValue.Builder clearSourceUuid() {
      source_uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pzybrick.avro.schema.SourceSensorValue.Builder setSensorUuid(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pzybrick.avro.schema.SourceSensorValue.Builder clearSensorUuid() {
      sensor_uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pzybrick.avro.schema.SourceSensorValue.Builder setSensorValue(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pzybrick.avro.schema.SourceSensorValue.Builder clearSensorValue() {
      sensor_value = null;
