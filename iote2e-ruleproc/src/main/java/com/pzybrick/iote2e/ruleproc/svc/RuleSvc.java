...
public abstract class RuleSvc {
	...
	protected abstract SourceSensorActuator findSourceSensorActuator(String sourceUuid, String sensorUuid)
			throws Exception;

	protected abstract void updateActuatorValue(SourceSensorActuator sourceSensorActuator) throws Exception;

	protected abstract RuleSourceSensor findRuleSourceSensor(String sourceUuid, String sensorUuid) throws Exception;


	public List<RuleEvalResult> process(String sourceUuid, String sensorUuid, String sensorValue) throws Exception {
		List<RuleEvalResult> ruleEvalResults = null;
		RuleSourceSensor ruleSourceSensor = findRuleSourceSensor( sourceUuid, sensorUuid);
		if( ruleSourceSensor != null ) {
			...
			ruleEvalResults = ruleEval( sourceUuid, sensorUuid, sensorValue, ruleDefItem);
		} else {
	...
	protected List<RuleEvalResult> ruleEval(String sourceUuid, String sensorUuid, String sensorValue,
	...
	private RuleEvalResult ruleEvalActuator(String sourceUuid, String sensorUuid, RuleDefCondItem ruleDefCondItem,
			RuleDefItem ruleDefItem) throws Exception {
		SourceSensorActuator sourceSensorActuator = findSourceSensorActuator(sourceUuid, sensorUuid);
